...
def optimize(bins_to_optimize, bin_to_reduce):
    ...
    **Example**
    ...
    """For each bin adjust the items till the bin is close to full"""
...
if __name__ == "__main__":
    ...
    print('Original bins - ' + str(orig_bins))
    print('Bin to optimize - ' + str(key_to_opt))
    print('Optimized bins - ' + str(opt_bins))
