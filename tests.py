...
class Testing(unittest.TestCase):
        ...
        expected =  \
            [{'b2': [('a2', 400), ('a6', 500), ('a11', 200), ('a1', 600)],
              ...
              'b4': [('a4', 200), ('a8', 200), ('a13', 200), ('a7', 200),
                     ('a9', 400), ('a5', 250)]},
             {'bin1': [('a1', 600), ('a5', 250), ('a10', 400), ('a6', 500)],
              'b3': [('a3', 700), ('a7', 200), ('a12', 300), ('a11', 200)],
              'b4': [('a4', 200), ('a8', 200), ('a13', 200), ('a7', 200),
                     ('a9', 400), ('a2', 400)]},
             {'bin1': [('a1', 600), ('a5', 250), ('a10', 400), ('a7', 200)],
    ...
    def test_incorrect_tuple(self):
        test_set = {'bin1': [2], 'b2': 4}
        with self.assertRaises(TypeError):
            optimize(test_set, 'bin1')
    ...
    def test_empty_bin(self):
        test_set = {'bin1': [('a1', 2)], 'b2': []}
        self.assertEqual({'bin1': [('a1', 2)]}, optimize(test_set, 'b2'))
